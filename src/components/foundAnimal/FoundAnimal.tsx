  ...
  return (
    <div className={styles.container_found_pet}>
      ...
      <div className={styles.content_found}>
        ...
        <p className={styles.paragraph_found}>
          If you cannot take the animal with you, contact local animal shelters
          or animal welfare organizations. They can help you with temporary or
          permanent accommodation for the animal.
        </p>

        <h2 className={styles.sectionTitle_found}>Provide Information:</h2>
        <p className={styles.paragraph_found}>
          If the animal seems lost, you can try to find its owner by posting an
          announcement on social media, local newspapers, or animal shelters.
        </p>
        ...
        <h2 className={styles.sectionTitle_found}>How to Find a New Owner:</h2>
        <p className={styles.paragraph_found}>
